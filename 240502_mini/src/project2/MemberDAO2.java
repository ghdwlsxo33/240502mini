...
public class MemberDAO2 {
    ...
    public MemberDAO2(Member_List2 mList){
        this.mList = mList;
    ...
    /**한사람의 회원 정보를 얻는 메소드*/
    public MemberDTO2 getMemberDTO(String id){
    ...
    /**회원 등록*/
    public boolean insertMember(MemberDTO2 dto){
    ...
    /**회원정보 수정*/
    public boolean updateMember(MemberDTO2 vMem){
